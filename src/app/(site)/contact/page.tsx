...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      label: 'Hotline',
      value: '1900 6789',
      sub: '24/7 đối với các tình huống khẩn cấp',
    },
    {
      icon: MapPin,
      label: 'Headquarters',
      value: 'Da Nang High-Tech Park',
      sub: 'Liên Chiểu, TP. Đà Nẵng, Việt Nam',
    },
    {
      icon: Clock,
      label: 'Giờ làm việc',
      value: 'T2 – T6: 8:00 – 17:30',
      sub: 'Hotline hỗ trợ khẩn cấp 24/7',
    },
  ];
