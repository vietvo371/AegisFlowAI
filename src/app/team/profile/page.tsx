    ...
    <div className="max-w-lg mx-auto px-4 py-6 space-y-6">
        ...
        <CardContent className="pt-0 pb-5 px-5 flex items-end gap-4 -mt-8">
          ...
          <div className="pb-1">
            ...
            <Badge variant="outline" className="text-[9px] font-bold border-orange-400/50 text-orange-500 mt-0.5">
              <ShieldAlert size={9} className="mr-1" /> {t('teamMember')}
            </Badge>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-border">
        <CardHeader className="pb-3">
          <CardTitle className="text-sm font-bold">{t('contactInfo')}</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="space-y-1.5">
            <Label className="text-[10px] font-bold uppercase text-muted-foreground">{t('radioPhone')}</Label>
            <div className="relative">
          ...
          <div className="space-y-1.5">
            <Label className="text-[10px] font-bold uppercase text-muted-foreground">{t('email')}</Label>
