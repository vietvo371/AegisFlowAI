---
description: Workflow mô phỏng kịch bản ngập lụt. Định nghĩa scenario, chạy simulation, so sánh before/after, tạo báo cáo tác động.
---

# /simulate — Mô phỏng Ngập lụt
...
Sử dụng `flood-response-expert` để validate:
...
| Step | Agent |
|------|-------|
| Validate scenario | `flood-response-expert` |
