---
description: Workflow xử lý sự cố ngập lụt. Tạo incident, trigger prediction, generate recommendation, notify operator.
---

# /incident — Xử lý Sự cố Ngập lụt
...
Sử dụng `flood-response-expert` để validate business logic:
...
| Step | Agent |
|------|-------|
| Validate logic | `flood-response-expert` |
